...
const AdminDashboard = () => {
    ...
    const [contactedMap, setContactedMap] = useState({}); // new state for contacted ticks
    const navigate = useNavigate();

    // Load contacted info from localStorage when tab changes
    useEffect(() => {
